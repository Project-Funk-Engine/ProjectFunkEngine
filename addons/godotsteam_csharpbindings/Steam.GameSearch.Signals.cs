...
public static partial class Steam
{
    ...
    static Action<int, ulong, ulong> _requestPlayersForGameFinalResultAction = (
        result,
        searchId,
        gameId
    ) =>
    ...
    static Action<int, ulong, Godot.Collections.Dictionary> _requestPlayersForGameResultAction = (
        result,
        searchId,
        playerData
    ) =>
    ...
    static Action<int, long, Godot.Collections.Dictionary> _searchForGameProgressAction = (
        result,
        searchId,
        searchProgress
    ) =>
    ...
    static Action<int, ulong, Godot.Collections.Dictionary> _searchForGameResultAction = (
        result,
        searchId,
        searchResult
    ) =>
