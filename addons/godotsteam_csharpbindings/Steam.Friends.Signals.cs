...
public static partial class Steam
{
    ...
    static Action<ulong, uint, uint, uint> _avatarImageLoadedAction = (
        avatarId,
        avatarIndex,
        width,
        height
    ...
    static Action<ulong, ulong, bool, bool> _connectedChatLeaveAction = (
        chatId,
        steamId,
        kicked,
        dropped
    ...
    static Action<string, Godot.Collections.Array> _enumerateFollowingListSignalAction = (
        message,
        following
    ) =>
    {
    ...
    static Action<int, ulong, Godot.Collections.Dictionary> _equippedProfileItemsAction = (
        result,
        steamId,
        profileData
    ) =>
    ...
    public delegate void RequestClanOfficerListSignalEventHandler(
        string message,
        List<ClanOfficer> officerList
    );
    private static event RequestClanOfficerListSignalEventHandler RequestClanOfficerListSignalEvent;
    static Action<string, Godot.Collections.Array> _requestClanOfficerListSignalAction = (
        message,
        officerList
    ) =>
    {
