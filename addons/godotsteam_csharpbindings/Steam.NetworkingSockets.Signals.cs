...
public static partial class Steam
{
    ...
    static Action<long, Godot.Collections.Dictionary, long> _networkConnectionStatusChangedAction =
    ...
    static Action<long, string, string, Godot.Collections.Array> _fakeIPResultAction = (
        result,
        identity,
        fakeIP,
        portList
