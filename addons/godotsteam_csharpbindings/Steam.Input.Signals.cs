...
public static partial class Steam
{
    ...
    static Action<uint, long, Godot.Collections.Dictionary> _inputConfigurationLoadedAction = (
        appId,
        deviceHandle,
        configData
    ) =>
    ...
    static Action<uint, long, long, long, long> _inputGamepadSlotChangeAction = (
        appId,
        deviceHandle,
        deviceType,
        oldGamepadSlot,
