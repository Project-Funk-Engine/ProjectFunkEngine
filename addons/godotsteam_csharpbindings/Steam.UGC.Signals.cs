...
public static partial class Steam
{
    ...
    static Action<long, long, long, long> _getAppDependenciesResultAction = (
        result,
        fileId,
        appDependencies,
    ...
    static Action<long, long, bool, bool, bool> _getItemVoteResultAction = (
        result,
        fileId,
        voteUp,
        voteDown,
    ...
    static Action<long, long, long, long, bool> _ugcQueryCompletedAction = (
        handle,
        result,
        resultsReturned,
        totalMatching,
    ...
    static Action<long, long, bool> _userFavoriteItemsListChangedAction = (
        result,
        fileId,
        wasAddRequest
    ) =>
    ...
    static Action<long, uint, Godot.Collections.Dictionary> _workshopEulaStatusAction = (
        result,
        appId,
        eulaData
    ) =>
