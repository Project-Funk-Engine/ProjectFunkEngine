...
public static partial class Steam
{
    ...
    static Action<uint, bool, bool> _htmlCanGoBackandforwardAction = (
        browserHandle,
        goBack,
        goForward
    ) =>
    ...
    static Action<uint, string, string> _htmlFileOpenDialogAction = (
        browserHandle,
        title,
        initialFile
    ) =>
    ...
    static Action<uint, Godot.Collections.Dictionary> _htmlHorizontalScrollAction = (
        browserHandle,
        scrollData
    ) =>
    {
    ...
    static Action<uint, Godot.Collections.Dictionary> _htmlLinkAtPositionAction = (
        browserHandle,
        linkData
    ) =>
    {
    ...
    static Action<uint, Godot.Collections.Dictionary> _htmlNeedsPaintAction = (
        browserHandle,
        pageData
    ) =>
    {
    ...
    static Action<uint, Godot.Collections.Dictionary> _htmlNewWindowAction = (
        browserHandle,
        windowData
    ) =>
    {
    ...
    static Action<uint, uint, uint> _htmlSearchResultsAction = (
        browserHandle,
        results,
        currentMatch
    ) =>
    ...
    static Action<uint, string, string, string, bool> _htmlStartRequestAction = (
        browserHandle,
        url,
        target,
        postData,
    ...
    static Action<uint, Godot.Collections.Dictionary> _htmlUrlChangedAction = (
        browserHandle,
        urlData
    ) =>
    {
    ...
    static Action<uint, Godot.Collections.Dictionary> _htmlVerticalScrollAction = (
        browserHandle,
        scrollData
    ) =>
    {
