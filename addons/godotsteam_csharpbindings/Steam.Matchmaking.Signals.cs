...
public static partial class Steam
{
    ...
    static Action<ulong, long, string, long> _lobbyMessageAction = (
        lobbyId,
        user,
        message,
        chatType
    ...
    static Action<ulong, long, long, long> _lobbyChatUpdateAction = (
        lobbyId,
        changedId,
        makingChangeId,
        chatState
    ...
    static Action<ulong, long, bool, long> _lobbyJoinedAction = (
        lobby,
        permissions,
        locked,
        response
    ...
    static Action<ulong, ulong, string, ushort> _lobbyGameCreatedAction = (
        lobbyId,
        serverId,
        serverIP,
        port
